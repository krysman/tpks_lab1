...
public class MatrixConverter {
    ...
    public void correctMasks(int amountOfVertices){
        amountOfVertices -= 1;
    ...
    public int getAmountOfLoops(int pos2, long [] incidenceMatrix){
    ...
    public int isIncident(int pos1, int pos2, long [] incidenceMatrix){
